document.addEventListener('DOMContentLoaded', function() {
    var ultrassonografiaEl = document.getElementById('ultrassonografia');

    var ultrassonografia = new FullCalendar.Calendar(ultrassonografiaEl, {
      headerToolbar: {
